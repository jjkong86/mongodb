...
public final class IpAddressMatcher {
    ...
    public static void main(String[] args) {
        String ip = "1.231.85.46";
//        String ip = "1.0.0.0";
        IpAddressMatcher ipAddressMatcher = new IpAddressMatcher(ip);
        System.out.println(Arrays.toString(ipAddressMatcher.requiredAddress.getAddress()));
        System.out.println(ipAddressMatcher.requiredAddress.hashCode());
    }
}
